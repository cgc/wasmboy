...
// Catridge Ram
export const DEBUG_TRACE_RAM_LOCATION: i32 = DEBUG_GAMEBOY_MEMORY_LOCATION + DEBUG_GAMEBOY_MEMORY_SIZE;
export const DEBUG_TRACE_RAM_SIZE: i32 = 0x020000;

// Cartridge ROM
export const DEBUG_TRACE_ROM_LOCATION: i32 = DEBUG_TRACE_RAM_LOCATION + DEBUG_TRACE_RAM_SIZE;
export const DEBUG_TRACE_ROM_SIZE: i32 = 0x7e0400;

// Debug Memory
export const DEBUG_TRACE_GAMEBOY_MEMORY_LOCATION: i32 = DEBUG_TRACE_ROM_LOCATION + DEBUG_TRACE_ROM_SIZE;
export const DEBUG_TRACE_GAMEBOY_MEMORY_SIZE: i32 = 0xffff;

// Final General Size
export const WASMBOY_MEMORY_LOCATION: i32 = 0x000000;
export const WASMBOY_MEMORY_SIZE: i32 = DEBUG_TRACE_GAMEBOY_MEMORY_LOCATION + DEBUG_TRACE_GAMEBOY_MEMORY_SIZE + 1;
